...
function ChatToggle(props: ChatToggleProps) {
  ...
  return (
    <div className='z-50 flex flex-row items-center justify-between w-full p-4 uppercase cursor-pointer h-fit text-dimshadow bg-highlight' onClick={toggleChat}>
